      ...
      <div className="bg-[#1e1e1e] p-10 rounded-xl shadow-2xl text-center max-w-87.5 w-full">
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <input
            ...
            required
            autoFocus
            className="w-full p-3 bg-[#2d2d2d] border border-[#3d3d3d] text-white rounded-md text-base outline-none focus:border-[#00e55b] transition-colors"
          />
          <button
            type="submit"
            className="w-full p-3 bg-[#00e55b] hover:bg-[#04bf4e] text-white rounded-md text-base font-bold cursor-pointer transition-colors"
          >
            Unlock
          </button>
        </form>
